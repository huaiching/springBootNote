...
public class SpelExpressionService {
    private static final Logger log = LoggerFactory.getLogger(SpelExpressionService.class);
     ...
     * @param dataMap 條件變數
     */
    public FlowDefinitionEntity getFlow(String moduleType, Map<String, Object> dataMap) {
        // 流程定義表
        List<FlowDefinitionEntity> flowDefinitionEntityList = flowDefinitionService.getFolwList(moduleType);
        ...
        for (FlowDefinitionEntity flowDefinitionEntity : flowDefinitionEntityList) {
            ...
            String ruleCode = flowDefinitionEntity.getExpressionRule();
            try {
